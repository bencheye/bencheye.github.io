...
> 调用自己，且有终止条件
>
> ![image-20210618101432597](C:/Users/benche/AppData/Roaming/Typora/typora-user-images/image-20210618101432597.png)
...
1. 汉诺塔问题
   ...
   **思路：**把0~(n-2)个圆环看成一个整体，把最下面的第n-1个圆环看成一个。然后首先先把0~(n-2)个圆环经过C移动到B，再把最后一个圆环从A移动到C，最后再把0~(n-2)个圆环至A移动到C。只有第二步是一步问题，但是1和3是比原问题规模小了一个同样的问题
   ...
   ![image-20210618101749233](C:/Users/benche/AppData/Roaming/Typora/typora-user-images/image-20210618101749233.png)
...
![image-20210618113118386](C:/Users/benche/AppData/Roaming/Typora/typora-user-images/image-20210618113118386.png)

![image-20210618113142721](C:/Users/benche/AppData/Roaming/Typora/typora-user-images/image-20210618113142721.png)
...
![image-20210618202805240](C:/Users/benche/AppData/Roaming/Typora/typora-user-images/image-20210618202805240.png)
...
![image-20210618212522630](C:/Users/benche/AppData/Roaming/Typora/typora-user-images/image-20210618212522630.png)
...
- **二叉树存储方式**（表示方式）：
  ...
  - 顺序存储---列表存
    ...
    ![image-20210621111557960](C:/Users/benche/AppData/Roaming/Typora/typora-user-images/image-20210621111557960.png)
